// Original code by etil2jz, licensed under the GNU General Public License v3.0
// You can find the original code on https://github.com/etil2jz/Mirai/tree/purpur/1.18.2

package com.notsatvrn.graphene.util.math;
